# accounts/admin.py
# Replace your entire accounts/admin.py with this file
...
class AccountAdmin(UserAdmin):
    list_display  = ('email', 'first_name', 'last_name', 'is_active', 'is_admin', 'date_joined')
...
class UserAddressAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Address', {'fields': ('address_line', 'city', 'state', 'pincode', 'address_type')}),
