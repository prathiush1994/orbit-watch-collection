...
urlpatterns = [
    ...
    path(
        "brands/toggle/<int:brand_id>/", views.brand_toggle, name="admin_brand_toggle"
    ),
    path(
        "brands/suggestions/", views.brand_suggestions, name="admin_brand_suggestions"
    ),
    # ── Categories ───────────────────────────────────────
    ...
    path(
        ...
        views.category_suggestions,
        name="admin_category_suggestions",
    ),
    # ── Products ─────────────────────────────────────────
    path("products/", views.product_list, name="admin_product_list"),
    path("products/add/", views.product_add, name="admin_product_add"),
    path(
        "products/edit/<int:product_id>/", views.product_edit, name="admin_product_edit"
    ),
    path(
        "products/suggestions/",
        views.product_suggestions,
        name="admin_product_suggestions",
    ),
    # ── Variants ─────────────────────────────────────────
    path("variants/add/<int:product_id>/", views.variant_add, name="admin_variant_add"),
    path(
        "variants/edit/<int:variant_id>/", views.variant_edit, name="admin_variant_edit"
    ),
    path(
        "variants/image/add/<int:variant_id>/",
        views.variant_image_add,
        name="admin_variant_image_add",
    ),
    path(
        "variants/image/delete/<int:image_id>/",
        views.variant_image_delete,
    ...
    path(
        "orders/return/approve/<str:order_number>/",
        views.approve_return,
        name="adminpanel_approve_return",
    ),
    path(
        "orders/<str:order_number>/item/<int:item_id>/approve-return/",
        admin_order_views.admin_approve_item_return,
        name="admin_approve_item_return",
    ),
    # ── Coupons ──────────────────────────────────────────
