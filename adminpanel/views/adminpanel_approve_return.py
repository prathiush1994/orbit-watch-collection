# ─────────────────────────────────────────────────────────
# ADD THIS FUNCTION into your existing adminpanel/views.py
# It handles: approve return → restock + wallet refund
# ─────────────────────────────────────────────────────────
...
def approve_return(request, order_number):
    ...
    Actions:
      1. Restore stock for every item in the order
      2. Credit refund to user's wallet
      3. Set order status to 'Returned'
    """
    ...
    # 2. Refund to wallet
    # Refund = full order_total (what user paid after coupon + wallet)
    # wallet_used is part of order_total — both go back to wallet
