...
def inventory_list(request):
    ...
    return render(
        request,
        "adminpanel/inventory_list.html",
        {
            "active": "inventory",
...
def inventory_add_stock(request, inventory_id):
    ...
    return render(
        request,
        "adminpanel/inventory_add_stock.html",
        {
            "active": "inventory",
            "inventory": inventory,
            "logs": logs,
...
def inventory_log(request, inventory_id):
    inventory = get_object_or_404(
        Inventory.objects.select_related("variant", "variant__product"), pk=inventory_id
    )
