...
urlpatterns = [
    ...
    path(
        "change-password/", views.change_password,
        name="dashboard_change_password"),
    path(
        "change-password/verify/", views.verify_change_password,
        name="dashboard_verify_change_password",
    ),
    path(
        "change-password/resend/", views.resend_change_password_otp,
        name="dashboard_resend_change_password_otp",
    ),

    path(
        "delete-account/", views.delete_account,
        name="dashboard_delete_account"),
    path(
        "delete-account/verify/", views.verify_delete_account,
        name="dashboard_verify_delete_account",
    ),
    path(
        "delete-account/resend/", views.resend_delete_account_otp,
